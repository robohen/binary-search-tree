...
class BST {
	...
	// method to execute inorder traversal
	inorder ( node ) {
	...
	// method to execute preorder traversal
	preorder ( node ) {
		console.log( node.data );
	...
	// method to execute postorder traversal
	postorder ( node ) {
		if ( node === null ) return;
